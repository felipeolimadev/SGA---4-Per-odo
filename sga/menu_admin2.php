...
<li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li><a href="gerenciar_turmas.php">Gerenciar Turmas</a></li>
     <li><a href="aturmar_alunos.php">A Turmar Alunos</a></li>
...
<li class="dropdown">
  ...
  <ul class="dropdown-menu">
    ...
    <li class="dropdown-header"> <i class="fas fa-users"></i> Usuários</li>
    <li><a href="cadastro_usuario_novo.php"> <i class="fas fa-users-cog"></i> Cadastrar Usuarios</a></li>
    <li><a href="gerenciar_usuarios.php"> <i class="fas fa-users-cog"></i> Gerenciar Usuarios</a></li>
   <li role="separator" class="divider"></li>

    <li class="dropdown-header"> <i class="fas fa-address-card"></i> Alunos</li>
    <li><a href="importar_aluno.php"> <i class="fas fa-arrow-left"></i> Importar Alunos</a></li>
    <li role="separator" class="divider"></li>
    <li class="dropdown-header"> <i class="fas fa-file-contract"></i> Turmas</li>
    <li><a href="importar_turma.php"> <i class="fas fa-arrow-left"></i> Importar Turmas</a></li>
    <li role="separator" class="divider"></li>
    <li class="dropdown-header"> <i class="fas fa-graduation-cap"></i> Cursos</li>
    <li><a href="importar_curso.php"> <i class="fas fa-arrow-left"></i> Importar Cursos</a></li>    
  </ul>
...
<a class="navbar-brand" href="closed.php"> <i class="fas fa-sign-out-alt"></i>Sair</a>
